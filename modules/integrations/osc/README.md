...
Native compatibility for YimuQr's paid BOOTH avatar system. KitsuNexus does not include
...
These are original KitsuNexus implementations. No source files from the GPL-3.0
