...
// "Log in with Discord" for the official KitsuNexus backend features (Activity
...
// secret. The KitsuNexus backend (server/, deployed separately) does the whole
...
const okPage = '<!doctype html><meta charset="utf-8"><title>KitsuNexus</title>' +
...
function loginDiscordIdentity (backendBaseUrl) {
  return new Promise((resolve, reject) => {
    if (!backendBaseUrl) return reject(new Error('No KitsuNexus backend configured'))
