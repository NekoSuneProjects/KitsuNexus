...
// "Log in with Discord" for the official NekoSuneAPPS backend features (Activity
...
// secret. The NekoSuneAPPS backend (server/, deployed separately) does the whole
...
function loginDiscordIdentity (backendBaseUrl) {
  return new Promise((resolve, reject) => {
    if (!backendBaseUrl) return reject(new Error('No NekoSuneAPPS backend configured'))
