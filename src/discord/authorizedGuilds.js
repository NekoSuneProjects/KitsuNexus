...
//
// Ported from NekoSuneAPPS/server/src/authorizedGuilds.js — unchanged except for the
// data-dir path (this project's data/ instead of that one's).
...
module.exports = { isAuthorized, authorize, revoke, all, guildCount }
