...
window.electronAPI = {
  ...
  vrchatFavAvatars: () => ipcRenderer.invoke('vrchat:favAvatars'),
  localFavList: opts => ipcRenderer.invoke('localfav:list', opts),
  localFavAdd: entry => ipcRenderer.invoke('localfav:add', entry),
  localFavUpdate: (id, fields) => ipcRenderer.invoke('localfav:update', { id, ...fields }),
  localFavRemove: id => ipcRenderer.invoke('localfav:remove', id),
  localFavIsFavorited: (type, vrchatId) => ipcRenderer.invoke('localfav:isFavorited', { type, vrchatId }),
  localFavGetPath: () => ipcRenderer.invoke('localfav:getPath'),
  localFavExport: () => ipcRenderer.invoke('localfav:export'),
  localFavImport: () => ipcRenderer.invoke('localfav:import'),
  localFavChoosePath: () => ipcRenderer.invoke('localfav:choosePath'),
  cloudSyncStatus: () => ipcRenderer.invoke('cloudsync:status'),
  cloudSyncStartPairing: (baseUrl, deviceName) => ipcRenderer.invoke('cloudsync:startPairing', { baseUrl, deviceName }),
  cloudSyncPollPairing: () => ipcRenderer.invoke('cloudsync:pollPairing'),
  cloudSyncDisconnect: () => ipcRenderer.invoke('cloudsync:disconnect'),
  cloudSyncSetEnabled: enabled => ipcRenderer.invoke('cloudsync:setEnabled', enabled),
  ...
  // discord bot — official KitsuNexus bot mode (no token, backend-backed)
