...
This file is read automatically by Codex at the start of every session in this repo.
Anyone working on this project with Codex (NekoSuneVR, FumikoEcho, etc.) gets these same rules
...
FumikoEcho and NekoSuneVR both work on this repo through Codex. Instead of re-explaining
